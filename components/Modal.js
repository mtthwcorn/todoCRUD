...
export default function Modal(props) {
  ...
  useEffect(() => {
    set_document(document) // current document DOM -> sometimes document doesn't exist when we use it below so we make sure it exisits here 
  }, [] )

  if(!_document) {return null} 


  return ReactDom.createPortal( // render the element here in _document in the element with id 'portal'
